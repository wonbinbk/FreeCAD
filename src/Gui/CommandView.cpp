...
//===========================================================================
// Std_TreeUpdateSelectionVisual
//===========================================================================
TREEVIEW_CMD_DEF(UpdateSelectionVisual)

StdTreeUpdateSelectionVisual::StdTreeUpdateSelectionVisual()
  : Command("Std_TreeUpdateSelectionVisual")
{
    sGroup       = QT_TR_NOOP("TreeView");
    sMenuText    = QT_TR_NOOP("Update selection");
    sToolTipText = QT_TR_NOOP("Update selection highlight when revealing an object");
    sStatusTip   = sToolTipText;
    sWhatsThis   = "Std_TreeUpdateSelectionVisual";
...
public:
        ...
        :GroupCommand("Std_TreeViewActions")
    {
        ...
        addCommand(new StdTreeUpdateSelectionVisual());
