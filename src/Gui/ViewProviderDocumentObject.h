...
public:
    ...
    /// Return the view provider for an element.
    ///
    /// This is used by PropertyView to resolve the multi-dot element
    /// name generated by link view provider (see ViewProviderLink)
    //
    /// element is a '.' separated string specifiying sub component of the
    /// attached document object. The element may not necessary be one of the
    /// document objects return by claimChildren. 
    ///
    /// subelement is an optional pointer to return the remaining
    /// non-document-object sub-element name
    ///
