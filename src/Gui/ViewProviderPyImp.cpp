...
PyObject*  ViewProviderPy::canDropObject(PyObject *args)
{
    ...
    if (!PyArg_ParseTuple(args, "|OO!s", 
                &obj,&App::DocumentObjectPy::Type,&owner,&subname))
        return NULL;
    PY_TRY {
        bool ret;
        if(obj == Py_None)
            ...
            auto pcOwner = owner==Py_None?0:
                static_cast<App::DocumentObjectPy*>(owner)->getDocumentObjectPtr();
...
PyObject*  ViewProviderPy::dropObject(PyObject *args)
{
    ...
    PyObject *owner = Py_None;
    const char *subname = 0;
    if (!PyArg_ParseTuple(args, "O!|O!s", &App::DocumentObjectPy::Type,&obj,
                &App::DocumentObjectPy::Type,&owner,&subname))
        return NULL;
    PY_TRY {
